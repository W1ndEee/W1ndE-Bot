...
module.exports = {
    ...
    callback: async (client, interaction) => {
        ...
        if (targetUser.id === interaction.guild.ownerId) {
            await interaction.editReply("You can't timeout that user because they are the server owner");
            return;
        }
        ...
        if (msDuration < 5000 || msDuration > 2.419e9) {
            await interaction.editReply("Timeout duration cannot be less than 5 second or more than 28 days");
            return;
        }
        ...
        try {
            ...
            console.log(`Error when timing out the user: ${error}`);
        }
    },
